function EstS =  HPmodel3(year,yearu,alpha,omega,qx)

% USAGE :
% Estimates the parameters of the second 9 parameter Heligman Pollard model
...
ub = [500;1000;10;150;2.5;10;80; 1.3;1.5];
...
[paramv,fval,exitflag,output] = fminsearchbnd(@HP4,x01,lb,ub,options,ages,qxts,scal);
EstS.paramv   = scal.*paramv;
EstS.exitflag = exitflag;

y=HP4_Shape(paramv,ages,scal);
