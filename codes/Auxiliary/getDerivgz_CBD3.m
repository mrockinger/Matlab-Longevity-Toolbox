function [num,den]=getDerivgz_CBD3(k1,k2,k3,gz,Dxt,Ext,N,T,age,Nc,Ns1,Ns2)
...
% % h=0.0000001;
% % 
% % [Dhatp,dyp,qp,mp]=updatedydy_CBD3(k1,k2,k3,gz+h,Dxt,Ext,N,T,age,Nc,Ns1,Ns2);
% % Xp=Ext.*dyp.*qp./Dhatp;
% % [Dhatn,dyn,qn,mn]=updatedydy_CBD3(k1,k2,k3,gz-h,Dxt,Ext,N,T,age,Nc,Ns1,Ns2);
% % Xn=Ext.*dyn.*qn./Dhatn;
% % 
