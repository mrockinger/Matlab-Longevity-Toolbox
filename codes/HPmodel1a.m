function EstS =  HPmodel1a(year,yearu,alpha,omega,qx)

% USAGE :
% Estimates the arameters of the Heligman Pollard model with adjustment for high
% ages
...
ub = [500;1000;10;150;2.5;10;80; 1.3];
...
[paramv,fval,exitflag,output] = fminsearchbnd(@HP1a,x01,lb,ub,options,ages,qxts,scal);

EstS.paramv   = scal.*paramv;
EstS.exitflag = exitflag;

y = HP1a_Shape(paramv,ages,scal);
